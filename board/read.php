        ...
        <article class="post">
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              ...
              $arr=mysqli_fetch_array($result);
               ...
               ?>
              <h3 class="panel-title">제목: <?php echo $arr['title']; ?> </h3>
            <div style="text-align:right"><strong>작성자: <?php echo $arr['author_id'];?></strong></div>
            </div>
            <div class="panel-body"><?php echo $arr['contents'];?></div>
          </div>
          ...
          <tr>
            <td colspan="2"><div align="center">
              <button type="button" class="btn btn-secondry btn-info">답변하기</button>
              <a type="button" class="btn btn-secondry btn-warning" href="../../page.php">목록으로</a>
            </td>
