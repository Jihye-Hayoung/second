  ...
  <header class="entry-header" style="background-image: url(img/s-1.jpg);">
	...
	<div class="container">
		<div class="row wow fadeInUp">
			...
			<div class="col-md-offset-3 col-md-6 page-block" style="padding:80px 0;">
				<form action="joining.php" method="post" style="padding-bottom:80px">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <input type="button" value="중복확인" onClick="id_check()" class="btn btn-success" >ID 중복확인</button>
              </span>
        	  </div>
          </div>
          ...
          <div class="form-group">
						...
						<input type="password" class="form-control" name="InputConfirm-Password" placeholder="Confirm Password">
					</div>

          <div class="form-group">
            <label for="username">본인확인용 이메일 주소</label>
            <div class="input-group">
              <input type="email" class="form-control" name="Email" placeholder="@hufs.ac.kr 계정으로 입력해주세요">
              <span class="input-group-btn">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control" name="ConfirmNumber" placeholder="인증번호">
              <span class="input-group-btn">
...
<!--메세지창!!!
    ...
    -->
          ...
          <div class="form-group text-center">
            <button type="submit" class="btn btn-info">Joining <i class="fa fa-check spaceLeft"></i></button>
            <a class="btn btn-warning" href="index.html">Cancel <i class="fa fa-times spaceLeft" ></a></i>
          </div>
