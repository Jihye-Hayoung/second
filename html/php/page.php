      ...
      <div class="col-md-10 col-sm-10 col-md-offset-1 single-post">
        <article class="post">
          ...
          <table class="table table-hover">
            ...
            <tr>
              <td>3</td>
              <td><a href="../viewpost.html">미국주립대학교로 어학연수 가고 싶은데 토플점수 필요한가요? </a></td>
              <td>임지혜</td>
              <td>2018.04.09</td>
              <td>47</td>
            </tr>
            <tr>
              <td>2</td>
              <td>일본어를 이중전공하고 있는데 일본으로 7+1 갈 수 있나요?</td>
              <td>지혜</td>
              <td>2018.04.03</td>
              <td>21</td>
            </tr>
        ...
        <a class="btn btn-default pull-right" href="../board-inner.html">글쓰기</a>
